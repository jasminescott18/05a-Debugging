...
########################################################################
#
# COMPLETED: 2. READ these instructions, ASKING QUESTIONS as needed.
#
...
# ----------------------------------------------------------------------
# COMPLETED: 3. Follow the INSTRUCTIONS AT THE TOP OF THIS MODULE
...
# ----------------------------------------------------------------------
# COMPLETED: 4. Follow the INSTRUCTIONS AT THE TOP OF THIS MODULE
#          to correct the mistake(s) in the following function.
# ----------------------------------------------------------------------
...
def broken_3(n, point, length, distance_between_lines, window):
    ...
    for _ in range(n):
        ...
        window.render(0.5)
        b = rg.Point(point.x, point.y + length + distance_between_lines)
